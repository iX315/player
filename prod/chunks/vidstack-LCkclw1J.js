...
import { IS_CHROME, canGoogleCastSrc, IS_IOS, IS_SERVER, loadScript } from './vidstack-Dd9F2fTb.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-Bivw3QVw.js')).GoogleCastProvider(this.#player, ctx);
  }
