...
import { IS_SERVER, useMediaState, isRemotionSrc, Primitive, useSliderState } from '../chunks/vidstack-Dd9F2fTb.js';
export { isRemotionProvider } from '../chunks/vidstack-Dd9F2fTb.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-CRSdisLA.js')).RemotionProvider(this.target, ctx);
  }
}
