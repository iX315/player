...
import { IS_CHROME, canGoogleCastSrc, IS_IOS, IS_SERVER, loadScript } from './vidstack-Dk5mBh_U.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-DK3v-pXm.js')).GoogleCastProvider(this.#player, ctx);
  }
