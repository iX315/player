...
import { IS_SERVER, useMediaState, isRemotionSrc, Primitive, useSliderState } from '../chunks/vidstack-Dk5mBh_U.js';
export { isRemotionProvider } from '../chunks/vidstack-Dk5mBh_U.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-D6hnu1X_.js')).RemotionProvider(this.target, ctx);
  }
}
